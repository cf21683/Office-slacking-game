...
public class JigsawPiece1 : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    private JigsawPuzzleManager1 manager;
    private float snapDistance;
    private Vector2 startPos;

    public void Initialize(Vector2 correctPos, float snapDist, Canvas c, JigsawPuzzleManager1 m)
    {
